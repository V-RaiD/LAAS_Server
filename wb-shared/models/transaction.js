...
let Schema = mongoose.Schema, log = require('../utils/logger.js').root.child({ 'module': __filename.substring(__dirname.length + 1, __filename.length - 3) }), constants = require('../utils/constants.js');
